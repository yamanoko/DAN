...
def get_teacher_model():
	dan_model_params = {
			...
			"model_params": {
				...
				"transfer_learning": {
					...
					"encoder": ["encoder", "../../dan-main/pretrained_models/dan_read_page.pt", True, True],
					"decoder": ["decoder", "../../dan-main/pretrained_models/dan_read_page.pt", True, False],
				},
	...
	checkpoint = torch.load("../../dan-main/pretrained_models/dan_read_page.pt", map_location="cpu", weights_only=False)
	charset = checkpoint["charset"]
	dan_manager = Manager(dan_model_params)
	dan_manager.params["model_params"]["vocab_size"] = len(charset)
	dan_manager.load_model()
	for model_name in dan_manager.models.keys():
		dan_manager.models[model_name].eval()
	dan_manager.dataset = FakeDataset(charset)
	return dan_manager